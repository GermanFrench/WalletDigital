...
public final class Account {
    ...
    private Account(UUID id, UUID userId, BigDecimal balance, String currency, AccountStatus status,
                    String accountNumber, String alias) {
    ...
    public static Account open(UUID id, UUID userId, String currency, String accountNumber, String alias) {
        return new Account(id, userId, BigDecimal.ZERO.setScale(MONEY_SCALE, RoundingMode.HALF_UP), currency,
                AccountStatus.ACTIVE, accountNumber, alias);
    }

    public static Account restore(UUID id, UUID userId, BigDecimal balance, String currency, AccountStatus status,
                                  String accountNumber, String alias) {
        return new Account(id, userId, balance, currency, status, accountNumber, alias);
    }
