...
public final class Transaction {
    ...
    public static Transaction credit(UUID id, UUID accountId, BigDecimal amount, Instant timestamp,
        ...
        return new Transaction(id, accountId, amount, TransactionType.CREDIT, TransactionStatus.COMPLETED,
                timestamp, description, relatedAccountId);
    }

    public static Transaction debit(UUID id, UUID accountId, BigDecimal amount, Instant timestamp,
                                    String description, UUID relatedAccountId) {
        return new Transaction(id, accountId, amount, TransactionType.DEBIT, TransactionStatus.COMPLETED,
                timestamp, description, relatedAccountId);
    }
    ...
    public static Transaction restore(UUID id,
                                      ...
                                      String description,
                                      UUID relatedAccountId) {
        return new Transaction(id, accountId, amount, type, status, timestamp, description, relatedAccountId);
    }
