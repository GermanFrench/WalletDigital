...
class SecurityIntegrationTest {
    ...
    void setUp() {
        ...
        String alias = "protected." + System.nanoTime();
        String accountNumber = "9" + String.format("%021d", Math.abs(System.nanoTime() % 1_000_000_000_000_000_000L));
        ...
        String responseBody = mockMvc.perform(post("/api/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                                                .content("""
                                                                ...
                                                                """.formatted(loginEmail, loginPassword)))
