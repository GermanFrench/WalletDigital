...
class AccountControllerTest {
    ...
    void shouldCreateAccount() {
        ...
        Account account = Account.restore(accountId, userId, BigDecimal.ZERO, "USD", AccountStatus.ACTIVE);
    ...
    void shouldDepositMoney() {
        UUID accountId = UUID.randomUUID();
        UUID userId = UUID.randomUUID();
        Account account = Account.restore(accountId, userId, new BigDecimal("150.00"), "USD", AccountStatus.ACTIVE);
    ...
    void shouldGetAccount() {
        UUID accountId = UUID.randomUUID();
        UUID userId = UUID.randomUUID();
        Account account = Account.restore(accountId, userId, new BigDecimal("42.00"), "USD", AccountStatus.ACTIVE);
    ...
    void shouldWithdrawMoney() {
        UUID accountId = UUID.randomUUID();
        UUID userId = UUID.randomUUID();
        Account account = Account.restore(accountId, userId, new BigDecimal("80.00"), "USD", AccountStatus.ACTIVE);
    ...
    void shouldTransferMoney() {
        ...
        UUID userId = UUID.randomUUID();
        Account account = Account.restore(accountId, userId, new BigDecimal("70.00"), "USD", AccountStatus.ACTIVE);
